...
| [マフィア](#Mafiaマフィア)                                           |  [カースメーカー](#CurseMakerカースメーカー)                                                           |                                        |
...
キルをしたときのテレポートは発生しません。<br>
また、キルボタンを押してから設定された時間が経つまでに会議が始まるか、ドールメーカー以外のプレイヤーに接触されると、とその瞬間にキルが発生します。<br>
...
死体を通報するごとに、インポスターのキルクールダウンを設定値づつ伸ばすことが出来ます。<br>
