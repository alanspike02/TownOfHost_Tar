...
public static class CustomRoleManager
{
    ...
    public static void OnMurderPlayer(PlayerControl appearanceKiller, PlayerControl appearanceTarget)
    {
        ...
        FixedUpdatePatch.FollowerSuicide(attemptTarget.PlayerId);

        FixedUpdatePatch.ServantSuicide(attemptTarget.PlayerId);
    ...
    public static void OnFixedUpdateAlways(PlayerControl player)
    {
            player.GetRoleClass()?.OnFixedUpdateAlways(player);
